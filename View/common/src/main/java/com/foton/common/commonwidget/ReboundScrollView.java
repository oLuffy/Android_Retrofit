package com.foton.common.commonwidget;
...
public class ReboundScrollView extends ScrollView {
        ...
        switch (ev.getActionMasked()) {
            ...
            case MotionEvent.ACTION_MOVE:
                ...
                if (mOverScrollTinyListener != null) {
                    mOverScrollTinyListener.scrollDistance((int) deltaY,
    ...
    public void setOverScrollTinyListener(
            OverScrollTinyListener OverScrollTinyListener) {
